...
def play_conversation(person1_stack, person2_queue):
    while not person1_stack.is_empty() or not person2_queue.is_empty():
        if not person1_stack.is_empty():
            print(f"Person 1: {person1_stack.pop()}")
...
def menu():
    ...
    # Push Person 1's messages onto the stack
    for msg in person1_messages:
        person1_stack.push(msg)
    ...
    while True:
        ...
        if choice == '1':
            print("\nPerson 1's Messages (Stack):")
            person1_stack.display()
            print("\nPerson 2's Messages (Queue):")
            person2_queue.display()
        elif choice == '2':
            print("\nPlaying the conversation:")
            play_conversation(person1_stack, person2_queue)
        elif choice == '3':
            print("Exiting...")
            break
        else:
